...
- **P0** — essential
- **P1** — important
- **P2** — useful corroboration/context
- **P3** — specialist/disputed

## P0 — exact copies requested from the author

Please obtain **lawfully accessible scans/PDFs of these exact editions when possible**. Do not substitute a random edition unless the requested edition cannot be obtained.
...
- al-Dhahabī / Ibn Ḥajar narrator-reference works as required

## Modern scholarship
Exact titles will be chosen case-by-case. We will deliberately include scholarship representing different methodological positions on:
- early sīrah formation;
- hadith historical method;
- isnād-cum-matn analysis;
- Qurʾanic historical context;
- chronology of Muhammad's life;
- seventh-century western Arabian social and political context.

## Acquisition rule
A source is not "locked" merely because a PDF has the right title. Verify title page, editor, publisher, edition, year, volume numbering, and pagination before it enters the publication citation layer.
